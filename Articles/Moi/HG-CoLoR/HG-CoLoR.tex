...
\begin{figure}
	\begin{center}
		...
		\begin{tikzpicture}[node distance=4cm,auto]
			...
			\node[state] [right of=TATACT] (ATACTG) {ATACTG};
			...
			(GTATAC) edge node {5} (TATACT)
					 edge [bend left] node {4} (ATACTG)
			(TATACT) edge node {5} (ATACTG)
			;
		\end{tikzpicture}
		}
	\end{center}
...
\begin{figure}
	...
	\resizebox{.9\textwidth}{!}{
		\begin{tikzpicture}			
			...
			\draw [->] (kmers) -- (PgSA);
			\node (IK) at (14.5,-1.5) {hybrid graph};
			\draw [->] (PgSA) -- (IK);			
			...
			\draw [->] (seeds) -- (Link);
			\draw [->] (IK) -- (Link);
			\node (SLR) at (20,-3.5) {corrected long reads};
			\draw [->] (Link) -- (SLR);
		\end{tikzpicture}
	}
	\end{center}
...
\begin{table}[ht]
	...
	\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}
		...
		& \textbf{Runtime} \\
		\hline		
		\multirow{6}{*}{\emph{A. baylyi}} & Original & 89,011 & 4,284 & 381,365,755 & 29,954 & 70.09\% & 0 & 100\% & N/A \\
		...
		\hline
		\multirow{6}{*}{\emph{E. coli}} & Original & 22,270 & 5,999 & 133,607,392 & 22,170 & 79.46\% & 0 & 100\% & N/A \\
		...
		\hline
		\multirow{6}{*}{Yeast} & Original & 205,923 & 5,698 & 1,173,389,509 & 68,215 & 55.49\% & 0 & 99.90\% & N/A \\
		...
		& NaS (fast) & 71,793 & 5,938 & 426,326,355 & 71,664 & 99.59\% & 59,788 & 98.70\% & \_ \\
		& NaS (sensitive) & 85,432 & 6,770 & 578,351,588 & 85,288 & 99.53\% & 69,816 & 99.17\% & \_ \\
		& HG-CoLoR & 71,518 & 6,604 & 472,306,800 & 71,393 & 99.17\% & 55,357 & 98.39\% & 99h16min \\
		\hline
	\end{tabular}
	}
	\end{center}
	\caption{Runtime and statistics of the long reads, before and after correction by the different tools. \label{tabid}}
\end{table}
